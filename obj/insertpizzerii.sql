...
v_pi1:=pizzerie('pizzerie','Avantage Pizza Fast',45.202 ,25.202,'str. Sararie','707111','Iasi','RO','Descriere','072 222 222' );--constructor implicit
v_pi2:=pizzerie('pizzerie','La Dolce Vita', 45.203 ,25.203,'str. Oastei 48','707222','Iasi','RO','Descriere','073 333 333');--constructor implicit
...
--insert into resurse_oop values('100',v_res1);
--insert into resurse_oop values('101',v_res2);
--insert into resurse_oop values('200', v_res3);
--insert into resurse_oop values('201', v_res4);
--insert into resurse_oop values('202', v_pi1);
--insert into resurse_oop values('203', v_pi2);
--insert into resurse_oop values('204', v_pi3);
--insert into resurse_oop values('205', v_pi4);
--insert into resurse_oop values('206', v_pi5);
--insert into resurse_oop values('207', v_pi6);

v_res3.afiseaza_informatii;
v_res4.afiseaza_informatii;
